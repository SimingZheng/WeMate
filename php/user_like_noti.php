...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../css/user_like_noti.css">
...
$sql_interest = "SELECT DISTINCT sender_ID FROM notifications WHERE receiver_ID = '$ID'";
...
//            else
    ...
    <div class="body">
        ...
        <div class="previous">
            ...
            if ($start > 0) {
                ?>
                <a href="user_like_noti.php?start=<?php echo $start - PAGE_SIZE ?>" class="previous_circle">
                ...
                if ($row != null) {
                    ...
                    <script type="text/javascript">
                        ...
                        function like(){
                            ...
                            var backpage = "user_like_noti.php";
                            //if("<?php //echo $start?>//") {
        ...
        <div class="next">
            ...
            if ($start + PAGE_SIZE < $num) {
                ?>
                <a href="user_like_noti.php?start=<?php echo $start + PAGE_SIZE ?> " class="next_circle">
    ...
    <div class="page">
        ...
        <div class="page_number">
            ...
            if ($num % 1 != 0)
                $k++;
            for ($l = 1; $l <= $k; $l++) { ?>
                <a href="user_like_noti.php?start=<?php echo $start1 + ($l - 1) * PAGE_SIZE ?>"><?php echo $l ?>&nbsp;&nbsp;&nbsp;&nbsp;</a>
                <?php
            }
            if (!$con)
...
<div class="footer">
    <div class="introduction"><p>Note: Wooer page - Show the request (the user who click "like" button to you)
            send by other users<br/>
           </p></div>
    <div class="brand">
        <p class="p1">WeMate |</p>
    </div>
