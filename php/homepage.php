...
$sql_interest = " SELECT DISTINCT u2.user_ID FROM interests u1 , interests u2 WHERE u1.interest_ID = u2.interest_ID AND u1.user_ID='$ID' 
                AND u2.user_ID IN (select user_ID from profile where gender =(SELECT seeking FROM profile WHERE user_ID = '$ID'))";
...
<div style="width: 100%" class="container">
    <div class="Note">
        <p class="Title">Potential results</p>
    ...
    <div class="body">
        ...
        <div class="previous">
            ...
            if ($start > 0) {
                ?>
                <a href="homepage.php?start=<?php echo $start - PAGE_SIZE ?>" class="previous_circle">
...
//                    alert("like has been send !");
//                    <?php
//                        $sql_liked= "SELECT * FROM notifications WHERE sender_ID = '$ID' AND receiver_ID = '$str'";
//                        $result_liked = mysqli_query($con, $sql_liked);
//                        $liked = $result_liked->fetch_assoc();
////                        if (empty($liked['sender_ID'])){
//                    $sql_like = "INSERT INTO notifications (sender_ID, receiver_ID) VALUES ('$ID','$str')";
//                    $result_like = mysqli_query($con, $sql_like);
////                }
////                        else{
////                            $sql_dislike = "DELETE FROM notifications WHERE sender_ID = '$ID' AND receiver_ID = '$str'";
////                            $result_dislike = mysqli_query($con, $sql_dislike);
//                    ?>
////                    alert("like has been cancel !");
//                }
            </script>
                    <?php
                }
        ...
        <div class="next">
            ...
            if ($start + PAGE_SIZE < $num) {
                ?>
                <a href="homepage.php?start=<?php echo $start + PAGE_SIZE ?> " class="next_circle">
    ...
    <div class="page">
        ...
        <div class="page_number">
            ...
            if ($num % 1 != 0)
                $k++;
            for ($l = 1; $l <= $k; $l++) { ?>
                <a href="homepage.php?start=<?php echo $start1 + ($l - 1) * PAGE_SIZE ?>"><?php echo $l ?>&nbsp;&nbsp;&nbsp;&nbsp;</a>
                <?php
            }
            if (!$con)
...
<div class="footer">
    <div class="introduction"><p>Note: The Homepage -Show object results filtered by user's interest and seeking</p></div>
    <div class="brand">
        <p class="p1">WeMate |</p>
    </div>
</div>
